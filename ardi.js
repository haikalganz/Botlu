...
@DENARA BOT <--- JAN DI HPS ENTR ERORR
...
====================================================[ BOTZ DENARA BOT ]==============================================================
SUBSCRIBE DENARA BOT SUBSCRIBE DENARA BOT
SUBSCRIBE DENARA BOT SUBSCRIBE DENARA BOT
SUBSCRIBE DENARA BOT SUBSCRIBE DENARA BOT
SUBSCRIBE DENARA BOT SUBSCRIBE DENARA BOT
SUBSCRIBE DENARA BOT SUBSCRIBE DENARA BOT
...
/**List FF **/
let _diamond1 = '• 70💎';     let diamond1 = 'Rp 9.600,00';
let _diamond2 = '• 100💎';     let diamond2 = 'Rp 14.000,00';
let _diamond3 = '• 140💎';     let diamond3 = 'Rp 18.800,00';
let _diamond4 = '• 210💎';     let diamond4 = 'Rp 28.900,00';
let _diamond5 = '• 355💎';   let diamond5 = 'Rp 48.000,00';
let _diamond6 = '• 500💎';   let diamond6 = 'Rp 70.000,00';
let _diamond7 = '• 720💎';   let diamond7 = 'Rp 98.000,00';
...
let _diamond12 = '💳 M.MINGGUAN';         let diamond12 = 'Rp 29.000,00';
let _diamond13 = '💳 M.BULANAN';         let diamond13 = 'Rp 147.000,00';
//--------------------------------//
///dmmlsini
...
//sewa price list 2.    
let sewa1 = 'JADI BOT 20K/BLN';     
let sewa2 = 'JADI BOT + OWNER 40K';
...
////< DAFTAR BUTTON BY Created Subscribe Denara Bot > ////
...
▹ ${prefix} wallgravity text1 text2
 `
sendButMessage(from, wibu, `Created Subscribe Denara Bot`, [
          {
...
`
   sendButMessage(from, wibu, `Created Subscribe Denara Bot`, [
        ...
        case 'simi':
              ...
              buttonsMessage = {footerText:'Created Subscribe Denara Bot', imageMessage: imageMsg,
...
▹ ${prefix} bokep25
 `
               ...
               sendButMessage(from, menu, `Created Subscribe Denara Bot`, [
          {
            buttonId: noprefix ? "menu" : "!"+"menu",
            buttonText: {
              displayText: `⬅️ BACK TO MENU `,
...
*Kirim Id Dengan Cara Ketik _Contoh : !id 123456789_*`
  buttons = [{buttonId: noprefix ? "owner" : "!"+"owner",buttonText:{displayText: `📝KIRIM ID NYA KAK📝`},type:1}]
              imageMsg = (await Lazuardi.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'SUBSCRIBE DENARA BOT', imageMessage: imageMsg,
...
*「 DENARA BOT 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			Lazuardi.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Daftar, Subscribe DENARA BOT*`)
		}, 2000)
        break
case 'sfire1':{
...
Wa.me/6283141727903`
   sendButMessage(from, titid, `Created Subscribe Denara Bot `, [
          {
...
"productId": "4120139628109348"
  ...
  case 'scan':
    ...
    "listMessage": {
      ...
      "footerText": "\nPowered Created Subscribe Denara Bot.                                        "
    }
  }, {quoted:kyy})
  Lazuardi.relayWAMessage(list, {waitForAck: true})
  break
...
//------------------< Owner >-------------------
      ...
      case 'bcbutton':
			...
			"footerText": 'Created Subscribe Denara Bot',
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              Lazuardi.sendMessage('6289696454872@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
if (!isGroup && isCmd && !kyy.key.fromMe){
	tek = `Created Subscribe Denara Bot`
